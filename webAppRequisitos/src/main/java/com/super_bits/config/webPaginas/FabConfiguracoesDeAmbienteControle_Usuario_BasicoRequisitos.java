 ...
 */
public enum FabConfiguracoesDeAmbienteControle_Usuario_BasicoRequisitos {
    ...
    public ItfConfigSBPersistencia getConfiguracaoPersistencia() {
        return new ConfigPersistenciaControle_Usuario_Basico();
    }

    public ItfConfigWebPagina getConfiguracaoWebPaginas() {
        return new ConfigWPControle_Usuario_Basico();
    }
